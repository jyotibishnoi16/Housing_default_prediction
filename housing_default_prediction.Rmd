...
setwd("/Users/jyotismac/Library/CloudStorage/OneDrive-Queen'sUniversityBelfast/Dissertation/Dataset search/Credit default risk- using for dissertation/excel formats")
# load libraries
library(readxl)
library(dplyr)
library(dlookr)
